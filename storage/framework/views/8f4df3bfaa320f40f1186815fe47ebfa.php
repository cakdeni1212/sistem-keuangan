...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between">
            ...
            <a href="<?php echo e(route('settings.index')); ?>" class="btn-secondary btn-sm">Pengaturan Lain</a>
        </div>
     <?php $__env->endSlot(); ?>
    ...
    <div x-data="{ show: true }"
        ...
        <div class="flex-1 min-w-0">
            ...
            <p class="text-xs text-emerald-600 mt-0.5"><?php echo e(session('success')); ?></p>
        </div>
    ...
    <div class="py-6 px-4 sm:px-6 lg:px-8">
        <div class="max-w-3xl mx-auto">
            ...
            <form method="POST" action="<?php echo e(route('settings.landing.update')); ?>" enctype="multipart/form-data" x-data="landingBuilder(<?php echo e(json_encode($config)); ?>)">
                <?php echo csrf_field(); ?>
                            ...
                            <template x-for="(field, fIdx) in section.fields" :key="fIdx">
                                <div>
                                    ...
                                    <div x-show="section.key === 'about' && field.key === 'description'">
                                        <?php $abtBg = \App\Models\AppSetting::get('landing_about_bg', ''); ?>
                                        <div class="mt-4 pt-4 border-t border-surface-100">
                                            ...
                                            <div class="relative mb-3 rounded-xl overflow-hidden border border-surface-200 h-24">
                                                <img src="<?php echo e($abtBg); ?>" class="w-full h-full object-cover">
                                                <form method="POST" action="<?php echo e(route('settings.landing.update')); ?>" class="absolute top-2 right-2">
                                            ...
                                            <?php endif; ?>
                                            <form method="POST" action="<?php echo e(route('settings.landing.update')); ?>" enctype="multipart/form-data" class="flex items-center gap-2">
                                                <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                                    ...
                                    <div x-show="section.key === 'menu' && field.key === 'label'" x-data="{ files: [], previews: [] }">
                                        <?php $menuImages = json_decode(\App\Models\AppSetting::get('landing_menu_images', '[]'), true) ?: []; ?>
                                        <div class="mt-4 pt-4 border-t border-surface-100">
                                            ...
                                            <div class="grid grid-cols-3 sm:grid-cols-5 gap-2 mb-4">
                                                ...
                                                <?php $imgUrl2 = is_string($img) ? $img : ($img['url'] ?? ''); ?>
                                                <div class="relative group rounded-lg overflow-hidden border border-surface-200 aspect-[3/4] bg-surface-50">
                                                    <img src="<?php echo e($imgUrl2); ?>" class="w-full h-full object-cover">
                                                    <form method="POST" action="<?php echo e(route('settings.landing.update')); ?>" class="absolute inset-0 opacity-0 group-hover:opacity-100 transition bg-black/40 flex items-center justify-center">
                                                        <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                                                        <input type="hidden" name="delete_menu_image" value="<?php echo e($imgUrl2); ?>">
                ...
                <div class="flex items-center justify-between pt-4 mt-4 border-t border-surface-100">
                    <a href="<?php echo e(url('/')); ?>" target="_blank" class="btn-secondary">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                <div class="card">
                    ...
                    <div class="p-5">
                        <?php $logo = \App\Models\AppSetting::get('landing_logo', ''); ?>
                        <?php if($logo): ?>
                        <div class="relative mb-3 rounded-xl overflow-hidden border border-surface-200 h-24 w-24 mx-auto">
                            <img src="<?php echo e($logo); ?>" class="w-full h-full object-contain">
                            <form method="POST" action="<?php echo e(route('settings.landing.update')); ?>" class="absolute top-1 right-1">
                                <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                        ...
                        <?php endif; ?>
                        <form method="POST" action="<?php echo e(route('settings.landing.update')); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                ...
                <div class="card">
                    ...
                    <div class="p-5">
                        <?php $favicon = \App\Models\AppSetting::get('landing_favicon', ''); ?>
                        <?php if($favicon): ?>
                        <div class="relative mb-3 rounded-xl overflow-hidden border border-surface-200 h-16 w-16 mx-auto">
                            <img src="<?php echo e($favicon); ?>" class="w-full h-full object-contain">
                            <form method="POST" action="<?php echo e(route('settings.landing.update')); ?>" class="absolute top-1 right-1">
                                <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
            ...
            <div class="card mb-4">
                ...
                <div class="p-5">
                    ...
                    <div class="relative mb-4 rounded-xl overflow-hidden border border-surface-200 h-32">
                        <img src="<?php echo e($heroBg); ?>" class="w-full h-full object-cover">
                    </div>
                    <?php endif; ?>
                    <form method="POST" action="<?php echo e(route('settings.landing.update')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                        <div class="flex items-center gap-3">
                            ...
                            <?php if($heroBg): ?><button type="submit" name="delete_hero_bg" value="1" class="btn-danger btn-sm shrink-0">Hapus</button><?php endif; ?>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="card mb-4" x-data="{ files: [], previews: [] }">
                ...
                <div class="p-5">
                    <?php $slideshowImages = json_decode(\App\Models\AppSetting::get('landing_slideshow_images', '[]'), true) ?: []; ?>
                    <?php if(count($slideshowImages) > 0): ?>
                    <div class="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-3 mb-5">
                        <?php $__currentLoopData = $slideshowImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="relative group rounded-xl overflow-hidden border border-surface-200 aspect-[4/3] bg-surface-50">
                            <img src="<?php echo e($img); ?>" class="w-full h-full object-cover">
                            <form method="POST" action="<?php echo e(route('settings.landing.update')); ?>" class="absolute inset-0 opacity-0 group-hover:opacity-100 transition bg-black/40 flex items-center justify-center">
                                <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?> <input type="hidden" name="delete_image" value="<?php echo e($img); ?>">
            ...
            <div class="card mb-4" x-data="{ files: [], previews: [] }">
                ...
                <div class="p-5">
                    ...
                    <div class="space-y-3 mb-5" id="menu-image-list">
                        <?php $__currentLoopData = $menuImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="flex gap-3 bg-surface-50 rounded-xl p-3">
                            <div class="flex flex-col gap-1 shrink-0">
                                <form method="POST" action="<?php echo e(route('settings.landing.update')); ?>" class="inline">
                                    <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                                    <input type="hidden" name="move_menu_image" value="<?php echo e($imgUrl); ?>">
                                    <input type="hidden" name="direction" value="up">
                                    <button type="submit" <?php echo e($i === 0 ? 'disabled' : ''); ?> class="w-6 h-6 rounded text-surface-400 hover:text-brand-600 <?php echo e($i === 0 ? 'opacity-30' : ''); ?>" title="Geser ke atas">▲</button>
                                </form>
                                <form method="POST" action="<?php echo e(route('settings.landing.update')); ?>" class="inline">
                                    <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                                    <input type="hidden" name="move_menu_image" value="<?php echo e($imgUrl); ?>">
                                    <input type="hidden" name="direction" value="down">
                                    <button type="submit" <?php echo e($i === count($menuImages) - 1 ? 'disabled' : ''); ?> class="w-6 h-6 rounded text-surface-400 hover:text-brand-600 <?php echo e($i === count($menuImages) - 1 ? 'opacity-30' : ''); ?>" title="Geser ke bawah">▼</button>
                                </form>
                            </div>
                            ...
                            <div class="flex-1 min-w-0">
                                <form method="POST" action="<?php echo e(route('settings.landing.update')); ?>">
                                    <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                                    <input type="hidden" name="edit_menu_image" value="<?php echo e($imgUrl); ?>">
                                    <input type="text" name="menu_title" value="<?php echo e($imgTitle); ?>" placeholder="Judul menu" class="input-field !py-1.5 !text-xs mb-1">
                                    <div class="flex gap-2">
                                        <input type="text" name="menu_desc" value="<?php echo e($imgDesc); ?>" placeholder="Deskripsi singkat" class="input-field !py-1.5 !text-xs flex-1">
                                        <button type="submit" class="btn-primary btn-sm !text-xs shrink-0">Simpan</button>
                                    </div>
                                </form>
                            </div>
                            <form method="POST" action="<?php echo e(route('settings.landing.update')); ?>" class="shrink-0 flex items-start">
                                <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                                <input type="hidden" name="delete_menu_image" value="<?php echo e($imgUrl); ?>">
...
<?php endif; ?>
<?php /**PATH /Users/deniubaidillah/Documents/Project/Sistem_Keuangan_clean/resources/views/settings/landing.blade.php ENDPATH**/ ?>