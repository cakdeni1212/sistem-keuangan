        ...
        <div class="max-w-2xl mx-auto space-y-6">
            ...
            <div class="bg-brand-50 border border-brand-200 rounded-xl p-5 flex gap-4">
                ...
                <div>
                    ...
                    <a href="<?php echo e(route('daily-revenues.template')); ?>"
                       class="btn-primary">
            ...
            <form action="<?php echo e(route('daily-revenues.upload')); ?>" method="POST" enctype="multipart/form-data"
                ...
                <div class="flex gap-3">
                    ...
                    <a href="<?php echo e(route('daily-revenues.index')); ?>"
...
<?php endif; ?>
<?php /**PATH /Users/deniubaidillah/Documents/Project/Sistem_Keuangan_clean/resources/views/daily-revenues/upload.blade.php ENDPATH**/ ?>