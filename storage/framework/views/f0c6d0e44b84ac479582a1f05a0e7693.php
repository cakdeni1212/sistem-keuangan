...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center gap-3">
            <a href="<?php echo e(route('hpp-products.index')); ?>" class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white border border-surface-300 text-surface-700 text-sm font-medium rounded-xl hover:bg-surface-50 transition">&larr; Kembali</a>
            <h2 class="text-lg font-bold text-surface-900">Tambah HPP Produk</h2>
        </div>
     <?php $__env->endSlot(); ?>
    ...
    <div class="py-6 px-4 sm:px-6 lg:px-8">
        <div class="max-w-3xl mx-auto" x-data="{
            ...
            <form action="<?php echo e(route('hpp-products.store')); ?>" method="POST" class="space-y-6">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="number" name="stok_minimum" value="<?php echo e(old('stok_minimum')); ?>" min="0"
                                    class="w-full border border-surface-300 rounded-xl px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500"
                                    placeholder="Cth: 10">
                                ...
                                <div class="flex items-center gap-2 bg-surface-50 rounded-xl p-3 flex-wrap">
                                    ...
                                    <div class="w-24">
                                        <select :name="'ingredients['+index+'][usage_unit]'"
                                            ...
                                            class="w-full form-select bg-white">
                                            <template x-for="u in availableUnits(item.raw_material_id)" :key="u.v">
                                                <option :value="u.v" x-text="u.l"></option>
                                            </template>
                                        </select>
                                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-surface-700 mb-1">
                                    Bahan Baku <span class="text-red-500" x-show="!hasIngredients">*</span>
                                </label>
                                <div class="relative">
                                    <span class="absolute left-3 top-2 text-surface-500 text-sm">Rp</span>
                                    <input type="number" name="bahan_baku" value="<?php echo e(old('bahan_baku', 0)); ?>"
                                ...
                                <p class="text-xs text-surface-400 mt-1" x-show="!hasIngredients">Kopi, susu, gula, cup, dll.</p>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <span class="absolute left-3 top-2 text-surface-500 text-sm">Rp</span>
                                    <input type="number" name="tenaga_kerja" value="<?php echo e(old('tenaga_kerja', 0)); ?>"
                                        min="0" step="any" x-model="tenagaKerja"
                                        class="w-full border border-surface-300 rounded-xl pl-10 pr-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500">
                                </div>
                                <p class="text-xs text-surface-400 mt-1">Upah barista per sajian.</p>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-surface-700 mb-1">
                                    Overhead <span class="text-red-500">*</span>
                                </label>
                                <div class="relative">
                                    <span class="absolute left-3 top-2 text-surface-500 text-sm">Rp</span>
                                    <input type="number" name="overhead" value="<?php echo e(old('overhead', 0)); ?>"
                                        min="0" step="any" x-model="overhead"
                                        class="w-full border border-surface-300 rounded-xl pl-10 pr-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500">
                                </div>
                                <p class="text-xs text-surface-400 mt-1">Listrik, sewa, penyusutan.</p>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="md:w-1/2">
                            ...
                            <div class="relative">
                                <span class="absolute left-3 top-2 text-surface-500 text-sm">Rp</span>
                                <input type="number" name="harga_jual" value="<?php echo e(old('harga_jual', 0)); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="p-6 space-y-4">
                        <div>
                            ...
                            <textarea name="notes" rows="2"
                                ...
                                placeholder="Catatan tambahan mengenai produk ini..."><?php echo e(old('notes')); ?></textarea>
                        </div>
                        <div class="flex items-center gap-2">
                            ...
                            <label for="is_active" class="text-sm text-surface-700">Produk Aktif (tampil di daftar)</label>
                        </div>
                    </div>
                ...
                <div class="flex gap-3">
                    <button type="submit"
                        class="gradient-brand text-white shadow-sm shadow-brand-200 hover:shadow-md px-6 py-2 rounded-xl font-medium text-sm transition">
                        Simpan Produk
                    </button>
...
<?php endif; ?>
<?php /**PATH /Users/deniubaidillah/Documents/Project/Sistem_Keuangan_clean/resources/views/hpp-products/create.blade.php ENDPATH**/ ?>