...
<head>
    ...
    <title><?php echo e($getField($heroSection, 'page_title', \App\Models\AppSetting::get('business_name', 'Forka Coffee & Space'))); ?></title>
    <?php if($faviconUrl): ?>
...
<body>
    ...
    <nav style="position:fixed;top:0;left:0;right:0;z-index:40;background:rgba(28,25,23,0.9);backdrop-filter:blur(12px);border-bottom:1px solid rgba(255,255,255,0.06);">
        <div style="max-width:1200px;margin:0 auto;padding:0 1.5rem;height:3.5rem;display:flex;align-items:center;justify-content:space-between;">
            <div style="display:flex;align-items:center;gap:0.75rem;">
                <?php if($logoUrl): ?>
                <img src="<?php echo e($logoUrl); ?>" style="height:2rem;width:auto;border-radius:0.375rem;">
                <?php else: ?>
                ...
                <?php endif; ?>
                <span style="color:white;font-weight:700;font-size:0.9rem;"><?php echo e(\App\Models\AppSetting::get('business_name', 'FORKA COFFEE')); ?></span>
            </div>
            <div style="display:flex;align-items:center;gap:1.5rem;">
                ...
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('dashboard')); ?>" style="padding:0.4rem 1rem;background:#d97706;color:white;border-radius:0.5rem;text-decoration:none;font-size:0.8rem;font-weight:600;">Dashboard</a>
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" style="padding:0.4rem 1rem;background:#d97706;color:white;border-radius:0.5rem;text-decoration:none;font-size:0.8rem;font-weight:600;">Masuk</a>
                <?php endif; ?>
            </div>
        </div>
    </nav>
    ...
    <section style="display:flex;align-items:center;justify-content:center;padding:6rem 1.5rem 4rem;position:relative;overflow:hidden;min-height:100vh;<?php echo e($heroBg ? 'background:linear-gradient(rgba(0,0,0,0.65),rgba(0,0,0,0.65)),url('.$heroBg.') center/cover no-repeat;' : 'background:linear-gradient(135deg,#1c1917 0%,#292524 50%,#1c1917 100%);'); ?>">
        ...
        <div style="position:relative;z-index:1;text-align:center;max-width:700px;">
            ...
            <div style="display:inline-flex;align-items:center;gap:0.5rem;padding:0.4rem 1rem;border-radius:999px;background:rgba(217,119,6,0.15);color:#fbbf24;font-size:0.75rem;font-weight:600;margin-bottom:1.5rem;">
                ...
                <?php echo e($heroBadge ?: 'Coffee & Space • Forka'); ?>

            </div>
            <h1 style="font-size:clamp(2rem, 5vw, 3.5rem);font-weight:800;color:white;line-height:1.15;letter-spacing:-0.02em;">
                <?php echo e($heroTitle); ?><br>
                <span style="color:#f59e0b;"><?php echo e($heroTagline); ?></span>
            </h1>
            <p style="color:#a8a29e;font-size:1.05rem;margin-top:1rem;line-height:1.6;max-width:500px;margin-left:auto;margin-right:auto;">
                <?php echo e($getField($heroSection, 'subtitle', 'Nikmati suasana nyaman dengan kopi pilihan dan makanan lezat.')); ?>
    ...
    <section style="padding:3rem 0;background:#1c1917;overflow:hidden;border-top:1px solid rgba(255,255,255,0.05);border-bottom:1px solid rgba(255,255,255,0.05);">
        <div style="max-width:1200px;margin:0 auto;padding:0 1.5rem;margin-bottom:1.5rem;">
            <p style="color:#a8a29e;font-size:0.8rem;font-weight:600;letter-spacing:0.1em;text-transform:uppercase;text-align:center;"><?php echo e($getField($slideshowSection, 'label', 'Suasana Forka Coffee')); ?></p>
        </div>
        <div style="display:flex;overflow:hidden;">
            <div class="slide-track">
                ...
                ?>
                <?php $__currentLoopData = array_merge($images, $images); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="slide-item" style="background-image:url('<?php echo e($img); ?>');"></div>
    ...
    <section id="menu" style="padding:4rem 1.5rem;background:#f5f5f4;">
        <div style="max-width:1200px;margin:0 auto;">
            <div style="text-align:center;margin-bottom:2rem;">
                <span style="display:inline-block;padding:0.3rem 0.8rem;border-radius:999px;background:#fef3c7;color:#b45309;font-size:0.7rem;font-weight:600;text-transform:uppercase;letter-spacing:0.05em;margin-bottom:0.75rem;"><?php echo e($getField($menuSection, 'label', 'Menu Kami')); ?></span>
            ...
            <div style="display:flex;gap:1rem;overflow-x:auto;padding-bottom:1rem;scroll-snap-type:x mandatory;-webkit-overflow-scrolling:touch;scrollbar-width:none;">
                <?php $__currentLoopData = $menuImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php $imgUrl = is_string($img) ? $img : ($img['url'] ?? ''); $imgTitle = is_string($img) ? '' : ($img['title'] ?? ''); $imgDesc = is_string($img) ? '' : ($img['desc'] ?? ''); ?>
                <div style="flex-shrink:0;width:280px;scroll-snap-align:start;border-radius:1rem;overflow:hidden;box-shadow:0 4px 15px rgba(0,0,0,0.08);background:white;">
                    <img src="<?php echo e($imgUrl); ?>" style="width:100%;height:320px;object-fit:cover;display:block;">
                    <?php if($imgTitle || $imgDesc): ?>
                    <div style="padding:0.75rem;">
                        <?php if($imgTitle): ?><p style="font-weight:700;font-size:0.8rem;color:#1c1917;"><?php echo e($imgTitle); ?></p><?php endif; ?>
                        <?php if($imgDesc): ?><p style="font-size:0.7rem;color:#78716c;margin-top:0.15rem;"><?php echo e($imgDesc); ?></p><?php endif; ?>
                    </div>
                    <?php endif; ?>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <?php if($aboutVisible): ?>
    <?php $aboutBg = \App\Models\AppSetting::get('landing_about_bg', '') ?: $getField($aboutSection, 'bg_image', ''); ?>
    
    <section id="about" style="padding:5rem 1.5rem;<?php echo e($aboutBg ? 'background:linear-gradient(rgba(245,245,244,0.95),rgba(245,245,244,0.95)),url('.$aboutBg.') center/cover no-repeat;' : 'background:#f5f5f4;'); ?>">
        <div style="max-width:1200px;margin:0 auto;display:grid;grid-template-columns:1fr 1fr;gap:3rem;align-items:center;">
            <div>
                ...
                <h2 style="font-size:1.75rem;font-weight:800;color:#1c1917;line-height:1.3;"><?php echo e($getField($aboutSection, 'title', 'Forka Coffee & Space')); ?></h2>
                <?php $aboutTagline = $getField($aboutSection, 'tagline', ''); ?>
                <?php if($aboutTagline): ?>
                <p style="color:#d97706;font-weight:600;font-size:1rem;margin-top:0.5rem;"><?php echo e($aboutTagline); ?></p>
                <?php endif; ?>
                <p style="color:#57534e;font-size:0.9rem;margin-top:1rem;line-height:1.7;">
                    <?php echo e($getField($aboutSection, 'description', 'Forka Coffee & Space adalah tempat nongkrong favorit.')); ?>
            ...
            <div style="border-radius:1rem;overflow:hidden;height:400px;<?php echo e($aboutBg ? 'background:url('.$aboutBg.') center/cover no-repeat;' : 'background:linear-gradient(135deg,#292524,#1c1917);'); ?>"></div>
        </div>
    </section>
    <?php endif; ?>

    <?php if($locationVisible): ?>
    <?php
    ...
    <section id="location" style="padding:5rem 1.5rem;background:white;">
        <div style="max-width:1200px;margin:0 auto;text-align:center;">
            <span style="display:inline-block;padding:0.3rem 0.8rem;border-radius:999px;background:#fef3c7;color:#b45309;font-size:0.7rem;font-weight:600;text-transform:uppercase;margin-bottom:0.75rem;"><?php echo e($getField($locationSection, 'label', 'Lokasi')); ?></span>
            <h2 style="font-size:1.75rem;font-weight:800;color:#1c1917;"><?php echo e($getField($locationSection, 'label', 'Temukan Kami')); ?></h2>
            <p style="color:#78716c;font-size:0.9rem;margin-top:0.5rem;max-width:400px;margin-left:auto;margin-right:auto;">
                <?php echo e(\App\Models\AppSetting::get('business_name', 'FORKA COFFEE & SPACE')); ?>

            </p>
            <?php if($mapsUrl): ?>
            <div style="margin-top:2rem;border-radius:1rem;overflow:hidden;border:1px solid #e7e5e4;">
                <iframe src="<?php echo e($mapsUrl); ?>" width="100%" height="350" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
            <?php endif; ?>
            <div style="margin-top:1.5rem;text-align:center;color:#57534e;">
                <p style="font-size:0.9rem;font-weight:600;color:#44403c;"><?php echo e(\App\Models\AppSetting::get('business_name', 'FORKA COFFEE & SPACE')); ?></p>
                <p style="font-size:0.8rem;margin-top:0.25rem;"><?php echo e($getField($locationSection, 'address', \App\Models\AppSetting::get('landing_address', 'Buka Senin - Sabtu, 08:00 - 22:00'))); ?></p>
            </div>
            <?php if($igUrl || $ttUrl || $waUrl): ?>
            <div style="margin-top:1.5rem;display:flex;gap:0.75rem;justify-content:center;flex-wrap:wrap;">
                <?php if($waUrl): ?>
                <a href="<?php echo e($waUrl); ?>" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.5rem;padding:0.6rem 1.2rem;background:#25D366;color:white;border-radius:0.75rem;text-decoration:none;font-size:0.85rem;font-weight:600;transition:transform 0.2s;" onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
                ...
                <?php endif; ?>
                <?php if($ttUrl): ?>
                <a href="<?php echo e($ttUrl); ?>" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.5rem;padding:0.6rem 1.2rem;background:#111111;color:white;border-radius:0.75rem;text-decoration:none;font-size:0.85rem;font-weight:600;transition:transform 0.2s;" onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
                ...
                <?php endif; ?>
                <?php if($igUrl): ?>
                <a href="<?php echo e($igUrl); ?>" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.5rem;padding:0.6rem 1.2rem;background:linear-gradient(135deg,#f58529,#dd2a7b,#8134af);color:white;border-radius:0.75rem;text-decoration:none;font-size:0.85rem;font-weight:600;transition:transform 0.2s;" onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
    ...
    <footer style="background:#1c1917;padding:2rem 1.5rem;border-top:1px solid rgba(255,255,255,0.06);">
        <div style="max-width:1200px;margin:0 auto;display:flex;flex-direction:column;align-items:center;gap:0.75rem;text-align:center;">
            <div style="display:flex;align-items:center;gap:0.5rem;">
                <?php if($logoUrl): ?>
                <img src="<?php echo e($logoUrl); ?>" style="height:1.5rem;width:auto;border-radius:0.25rem;">
                <?php else: ?>
                ...
                <?php endif; ?>
                <span style="color:white;font-weight:600;font-size:0.85rem;"><?php echo e(\App\Models\AppSetting::get('business_name', 'FORKA COFFEE & SPACE')); ?></span>
            </div>
            <p style="color:#a8a29e;font-size:0.75rem;">&copy; <?php echo e(date('Y')); ?> All rights reserved.</p>
        </div>
    </footer>

    
    <a href="https://wa.me/<?php echo e(\App\Models\AppSetting::get('wa_number', '6281234567890')); ?>" target="_blank" class="whatsapp-float" aria-label="WhatsApp">
...
<?php /**PATH /Users/deniubaidillah/Documents/Project/Sistem_Keuangan_clean/resources/views/welcome.blade.php ENDPATH**/ ?>