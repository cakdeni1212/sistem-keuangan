    ...
    <div class="py-6 px-4 sm:px-6 lg:px-8"
        ...
        <div class="mb-5 alert-warning flex gap-3">
            ...
            <div class="flex-shrink-0 flex flex-col gap-1.5 self-start">
                <a href="<?php echo e(route('penjualan-harian.show', [$date, 'pagi'])); ?>"
                   class="text-xs font-medium text-amber-700 underline hover:text-amber-900">
                    Lihat data →
                </a>
                <form method="POST" action="<?php echo e(route('penjualan-harian.destroy', [$date, 'pagi'])); ?>"
                      onsubmit="return confirm('Hapus semua data <?php echo e(\Carbon\Carbon::parse($date)->format('d/m/Y')); ?>? Tindakan ini tidak bisa dibatalkan.')">
                    <?php echo csrf_field(); ?>
