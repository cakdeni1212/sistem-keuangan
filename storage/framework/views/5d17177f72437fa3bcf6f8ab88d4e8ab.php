            ...
            <?php if($user instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! $user->hasVerifiedEmail()): ?>
                <div>
                    <p class="text-sm mt-2 text-surface-800">
                        ...
                        <button form="send-verification" class="underline text-sm text-surface-600 hover:text-surface-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-500">
...
<?php /**PATH /Users/deniubaidillah/Documents/Project/Sistem_Keuangan_clean/resources/views/profile/partials/update-profile-information-form.blade.php ENDPATH**/ ?>