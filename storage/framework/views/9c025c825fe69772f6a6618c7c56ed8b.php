...
<?php endif; ?>
        ...
        <div class="flex items-center justify-end mt-4">
            <a class="underline text-sm text-surface-600 hover:text-surface-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-500" href="<?php echo e(route('login')); ?>">
...
<?php endif; ?>
<?php /**PATH /Users/deniubaidillah/Documents/Project/Sistem_Keuangan_clean/resources/views/auth/register.blade.php ENDPATH**/ ?>