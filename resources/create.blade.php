<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <h2 class="text-lg font-bold text-gray-800">Tambah Karyawan</h2>
        </div>
    </x-slot>
        ...
        <div class="max-w-3xl mx-auto">
            ...
            <form action="{{ route('employees.store') }}" method="POST" class="space-y-5">
                ...
                <div class="flex gap-3">
                    <button type="submit" class="px-6 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 font-medium text-sm transition">Simpan</button>
                    <a href="{{ route('employees.index') }}" class="px-6 py-2 bg-white border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 font-medium text-sm transition">Batal</a>
                </div>
            </form>
        </div>
    </div>
