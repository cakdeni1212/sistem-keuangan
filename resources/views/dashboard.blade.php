    ...
    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
            <div class="stat-card hover:border-emerald-200 hover:shadow-emerald-100/50">
                ...
                <p class="page-title">Rp {{ number_format($totalOmset, 0, ',', '.') }}</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <div class="stat-card p-0">
                ...
                <div class="divide-y divide-surface-100">
                    @forelse($topCoffe as $item)
                    <div class="px-5 py-2.5 flex items-center justify-between hover:bg-surface-50 transition-colors">
                        <span class="text-sm font-medium text-surface-800">{{ $item->product_name }}</span>
                        <span class="text-xs font-semibold text-brand-600">{{ number_format($item->total_qty) }} terjual</span>
                    </div>
                    @empty
