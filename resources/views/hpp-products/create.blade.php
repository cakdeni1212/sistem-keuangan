<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            <a href="{{ route('hpp-products.index') }}" class="btn-secondary btn-sm">&larr; Kembali</a>
            <h2 class="page-title">Tambah HPP Produk</h2>
        </div>
    </x-slot>
    ...
    <div class="py-6 px-4 sm:px-6 lg:px-8">
        <div class="max-w-3xl mx-auto" x-data="{
            ...
            <form action="{{ route('hpp-products.store') }}" method="POST" class="space-y-6">
                @csrf
                    ...
                    <div class="p-6 space-y-4 border-b border-surface-100">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="number" name="stok_minimum" value="{{ old('stok_minimum') }}" min="0"
                                    class="w-full border border-surface-300 rounded-xl px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500"
                                    placeholder="Cth: 10">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="bahan_baku" value="{{ old('bahan_baku', 0) }}"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <span class="absolute left-3 top-2 text-surface-500 text-sm">Rp</span>
                                    <input type="number" name="tenaga_kerja" value="{{ old('tenaga_kerja', 0) }}"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <span class="absolute left-3 top-2 text-surface-500 text-sm">Rp</span>
                                    <input type="number" name="overhead" value="{{ old('overhead', 0) }}"
                    ...
                    <div class="p-6 space-y-4">
                        <div>
                            ...
                            <textarea name="notes" rows="2"
                                ...
                                placeholder="Catatan tambahan mengenai produk ini...">{{ old('notes') }}</textarea>
                        </div>
