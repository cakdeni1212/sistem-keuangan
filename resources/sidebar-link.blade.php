...
@php
$base = 'flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-150 w-full relative';
$classes = $active
    ? $base . ' bg-brand-50 text-brand-700 font-semibold'
    : $base . ' text-surface-600 hover:bg-surface-100 hover:text-surface-900';
@endphp

<a {{ $attributes->merge(['class' => $classes]) }}>
    @if($active)
    <span class="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-5 rounded-r-full gradient-brand"></span>
    @endif
    <span class="w-5 h-5 flex items-center justify-center flex-shrink-0">
        ...
        @elseif($icon === 'cash-register')
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 14l6-6m-5.5.5h.01m4.99 5h.01M19 21H5a2 2 0 01-2-2V5a2 2 0 012-2h14a2 2 0 012 2v14a2 2 0 01-2 2zM9 7h6v2H9V7z"/></svg>
        @elseif($icon === 'receipt')
